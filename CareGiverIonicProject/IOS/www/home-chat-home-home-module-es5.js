...
var HomePage = /** @class */ (function () {
    function HomePage(Aroute, router, user, auth) {
        ...
        var joinData = firebase_app__WEBPACK_IMPORTED_MODULE_2__["database"]().ref('chatrooms/' + this.roomkey + '/chats').push();
        joinData.set({
            type: 'join',
    ...
    HomePage.prototype.exitChat = function () {
        var exitData = firebase_app__WEBPACK_IMPORTED_MODULE_2__["database"]().ref('chatrooms/' + this.roomkey + '/chats').push();
        exitData.set({
            type: 'exit',
            user: this.displayName,
