...
let GarminService = class GarminService {
    constructor(afStore) {
        this.afStore = afStore;
    }
    getGarminDataset(uid) {
    ...
    getGarmin(uid, date) {
        return this.afStore.collection('users').doc(uid)
            .collection('garmin').doc(date).valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(user => {
            return user;
        }));
    }
};
GarminService.ctorParameters = () => [
