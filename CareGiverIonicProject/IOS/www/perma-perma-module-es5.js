...
var PermaPage = /** @class */ (function () {
    ...
    PermaPage.prototype.adlsChange = function (event) {
        return this.adls = event.detail.value;
    };
    PermaPage.prototype.careHoursChange = function (event) {
        return this.careHours = event.detail.value;
    };
    PermaPage.prototype.financialChange = function (event) {
        return this.financial = event.detail.value;
    };
    PermaPage.prototype.timeOffChange = function (event) {
        return this.timeOff = event.detail.value;
    };
    PermaPage.prototype.mentalConfusionChange = function (event) {
        return this.confusion = event.detail.value;
    };
    PermaPage.prototype.helpChange = function (event) {
    ...
    PermaPage.prototype.submit = function () {
        ...
        var adls = this.adls;
        var careHours = this.careHours;
        var financial = this.financial;
        var timeOff = this.timeOff;
        var confusion = this.confusion;
        var help = this.help;
        ...
        var wellbeingScore = Number(((Number(this.wellbeingScore) + Number(score)) / 23).toFixed(0));
        var data = { helped: helped, loved: loved, satisfied: satisfied, purposeful: purposeful, valuable: valuable, sense: sense, progress: progress, achieve: achieve, handle: handle,
            adls: adls, careHours: careHours, financial: financial, timeOff: timeOff, confusion: confusion, help: help, wellbeingScore: wellbeingScore };
        try {
