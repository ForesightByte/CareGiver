...
let HomePage = class HomePage {
    constructor(Aroute, router, user, auth) {
        ...
        const joinData = Firebase__WEBPACK_IMPORTED_MODULE_2__["database"]().ref('chatrooms/' + this.roomkey + '/chats').push();
        joinData.set({
            type: 'join',
        ...
        this.data.message = '';
        Firebase__WEBPACK_IMPORTED_MODULE_2__["database"]().ref('chatrooms/' + this.roomkey + '/chats').on('value', resp => {
            this.chats = [];
    ...
    sendMessage() {
        const newData = Firebase__WEBPACK_IMPORTED_MODULE_2__["database"]().ref('chatrooms/' + this.roomkey + '/chats').push();
        newData.set({
            type: this.data.type,
    ...
    exitChat() {
        const exitData = Firebase__WEBPACK_IMPORTED_MODULE_2__["database"]().ref('chatrooms/' + this.roomkey + '/chats').push();
        exitData.set({
            type: 'exit',
            user: this.displayName,
